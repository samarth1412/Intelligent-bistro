    ...
    },
    {
      ...
      content: JSON.stringify({
        ...
        expectedResponseShape: {
          ...
          assistantMessage: 'Short natural reply for the user.',
          confidence: 0.9,
          errors: [],
          intent: 'cart_update',
        },
        ...
        rules: [
          ...
          'When a message mentions multiple menu items joined by and or commas, return one action per item.',
          'Apply modifiers only to the item phrase they belong to. In "two spicy chicken sandwiches and a large water", large belongs to water only.',
          'Do not copy placeholder values from expectedResponseShape.',
